...
class ClinicalCase(models.Model):      
    ...
    case_classification = models.CharField(max_length=100, blank=True, null=True)
    symptoms = models.CharField(max_length=200, blank=True, null=True)    
    triage_level = models.CharField(max_length=100, blank=True, null=True)
    diagnosis_type = models.CharField(max_length=100, blank=True, null=True)    
    final_case_classification = models.CharField(max_length=100, blank=True, null=True)
    admission_status = models.CharField(max_length=100, blank=True, null=True)
